                                ...
                                <div class="col-12 col-md-6 col-lg-4">
                                    <form action="{{ getAdminPanelUrl() }}/store/settings" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="value[store_tax]" value="{{ (!empty($itemValue) and isset($itemValue['store_tax'])) ? $itemValue['store_tax'] : old('store_tax') }}" class="form-control text-center  @error('store_tax') is-invalid @enderror"/>
                                            @error('store_tax')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
